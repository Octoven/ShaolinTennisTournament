...
<body>
	...
	<main>
	<h2>Inscription</h2>
	<form id="form_register" method="post" action="AddCourt">
		<div id="idnumber">
			<label for="id">ID</label> <input type="text" id="id" name="id"
				placeholder='Uniquement pour modif.'>
		</div>
		<div id="cName">
			<label for="court">Court</label> <input type="text" id="court"
				name="nom" placeholder="Nom du court">
		</div>

		<div id="terrain">
			<label for="terrain">Terrain</label> <select id='Terrain'
				name="terrain">
				...
				<option value="Terre artificielle">Terre artificielle</option>
		...
		<input type="submit" id="record" name="update"
			value="Enregister le court" /> <input type="submit" id="update"
			name="update" value="Modifier le court" />
	</form>
	</main>

	<section>
		<form action="RemoveCourt" method="post">
			<h3>Tableau des courts</h3>
			<table id="courts">
				<tr>
					<th colspan="5">Courts enregistrés</th>
				</tr>
				<tr>
					<th>ID</th>
					<th>Court</th>
				...
				<c:if test="${liste != null}">
					...
					<c:forEach var="Court" items="${liste}">
						...
						<tr>
							...
							<td>${Court.nom} ${Umpire.nom}</td>
							<td>${Court.terrain}</td>
							<td>${Court.pays}</td>
							<td><input type="radio" name="select" value="${Court.court_id}"  /></td>

						</tr>

					</c:forEach>
					<tr>
						<td colspan="5"><input type="submit" value="Supprimer" 
							name="action" /></td>
					</tr>
				</c:if>
			</table>
