...
<link rel="stylesheet" type="text/css" href="css/umpires.css" />
...
<body>
	...
	<main>
	<h2>Inscription</h2>
	<form id="form_register" action="AddUmpire" method="post">
		<div id="idnumber">
		...
		<div id="fName">
			<label for="prenom">Prénom</label> <input type="text" id="prenom"
				name="prenom" placeholder="Prénom de l'arbitre">
		</div>
		<div id="sName">
		...
		<input type="submit" id="record" name="update"
			value="Enregister l'arbitre" /> <input type="submit" id="update"
			name="update" value="Modifier l'arbitre" />
	</form>
	</main>

	<section>
		<form action="RemoveUmpire" method="post">
			<h3>Tableau des arbitres</h3>
			<table id="arbitres">
				<tr>
					<th colspan="5">Arbitres enregistrés</th>
				</tr>
				<tr>
					<th>ID</th>
					<th>Arbitre</th>
				...
				<c:if test="${liste != null}">
					...
					<c:forEach var="Umpire" items="${liste}">
						...
						<tr>
							...
							<td>${Umpire.sexe}</td>
							<td>${Umpire.pays}</td>
							<td><input type="radio" name="select" value="${Umpire.umpire_id}" /></td>
