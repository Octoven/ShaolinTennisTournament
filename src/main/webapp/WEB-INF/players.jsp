...
<body>
	...
	<main>
	<h2>Inscription</h2>
	<form id="form_register" action="AddPlayer" method="post">
		<div id="idnumber">
			<label for="id">ID</label> <input type="text" id="id"
				name="id" placeholder='Uniquement pour modif.'>
		</div>
		<div id="fName">
		...
		<input type="submit" id="record" name="update" value="Enregister le joueur" />
		<input type="submit" id="update" name="update" value="Modifier le joueur" />
	</form>
	</main>
	...
	<section>
		<form action="RemovePlayer" method="post">
			...
			<table id="joueurs">
				<tr>
					<th colspan="5">Joueurs Enregistrés</th>
				</tr>
				<tr>
					<th>ID</th>
					<th>Joueur</th>
				...
				<c:if test="${liste != null}">
					...
					<tr>
						<td colspan="5"><input type="submit" value="Supprimer" name="action" /></td>
					</tr>
				</c:if>
			</table>
		</form>
